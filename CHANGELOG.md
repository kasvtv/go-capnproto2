...
- Better support for alternate `Arena` implementations
  - [Document `Arena` contract](https://godoc.org/github.com/kasvtv/go-capnproto2/v2#Arena)
    in more detail
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>First release under <code>github.com/kasvtv/go-capnproto2/v2</code></td>
    </tr>
  </tbody>
</table>
