...
capnpc-go provides the compiler backend for capnp.
	...
	capnp compile -I$GOPATH/src/github.com/MadBase/go-capnproto2/v2/std -ogo *.capnp
...
detect when two types are in the same package.  For example:
	...
	$Go.package("main");
	$Go.import("github.com/MadBase/go-capnproto2/v2/example");
...
*/
package capnp // import "github.com/MadBase/go-capnproto2/v2"
